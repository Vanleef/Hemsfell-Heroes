...
export const explicitCardRules = Object.freeze({
  p16: [ability("onPlay", [effect("modifyStats", { target: "anyCreature", subtype: "Dragão", attack: 0, health: 2, duration: "turn" })])],
  ...
  p124: [ability("onPlay", [effect("grantKeyword", { target: "anyCreature", subtype: "Malorga", keyword: "Toque da Morte", duration: "turn" })])],
