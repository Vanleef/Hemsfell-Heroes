...
export const defaultEffectHandlers = Object.freeze({
  ...
  conditionalStats(state, effect, context) { const source = findUnit(state, context.sourceId); if (source) { source.staticModifiers ||= []; source.staticModifiers.push(effect); } },
