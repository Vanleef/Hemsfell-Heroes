...
/* --------------------------------------------------------------------------
   Card-list tooltip portal
   -------------------------------------------------------------------------- */

const CARD_LIST_SELECTOR = [
...
function useCardListTooltipPortal() {
  useEffect(() => {
    ...
    const onPointerOver = (event: PointerEvent) => {
      ...
      if (!card || !card.closest(CARD_LIST_SELECTOR)) return;
