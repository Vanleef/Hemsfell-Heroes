...

{
  ...
  source = replaceOnce(source,
    'p41: [ability("onPlay", [effect("returnToHand", { target: "allyCreature", selections: 1 }), effect("discountReturnedCard", { amount: 1, duration: "turn" })], [], { condition: { cardsPlayedBeforeThisAtLeast: 1 } }), ability("onPlay", [effect("returnToHand", { target: "allyCreature", selections: 1 })], [], { condition: { cardsPlayedBeforeThisAtMost: 0 } })],',
    'p41: [ability("onPlay", [effect("returnToHand", { target: "allyCreature", selections: 1 }), effect("discountReturnedCardIfCombo", { amount: 1, duration: "turn" })])],',
    "Mete o Pé single target");
...

{
  ...
  if (!source.includes('discountReturnedCardIfCombo(state')) {
